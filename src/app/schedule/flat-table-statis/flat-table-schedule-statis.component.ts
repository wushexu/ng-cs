...
@Component({
  selector: 'app-flat-table-schedule-statis',
  templateUrl: './flat-table-schedule-statis.component.html',
  styleUrls: ['./flat-table-schedule-statis.component.css']
})
export class FlatTableScheduleStatisComponent implements AfterViewInit, OnInit, OnChanges {
  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;
  @ViewChild(MatTable) table: MatTable<ScheduleAggregated>;

  @Input() flatSchedules: FlatSchedulesStatis;
  @Input() showTitle;
